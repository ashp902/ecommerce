...
class RegisterUserForm(UserCreationForm):
    ...
    date_of_birth = forms.DateField(widget=forms.widgets.DateInput(attrs={'placeholder': 'Date of birth', 'onfocus': '(this.type="date")', 'onblur': '(this.type="text")'}))
    ...
    class Meta:
        model = User
        fields = ['email', 'username', 'password1', 'password2', 'first_name', 'last_name', 'date_of_birth', 'gender']
...
class AddressForm(forms.Form):
    ...
    class Meta:
        model = Address
        fields = ['door_no', 'street', 'area', 'city', 'state', 'country', 'pincode']
